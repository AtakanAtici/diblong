        ...
        <aside class="w-64 bg-gray-900 text-white flex-shrink-0 hidden lg:block">
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="{{ route('admin.users') }}"
                   class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.users') || request()->routeIs('admin.user.*') ? 'bg-gray-800 text-yellow-500' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }} transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="bg-white shadow-sm lg:hidden">
                <div class="flex items-center justify-between px-4 py-3">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('admin.users') }}" class="text-gray-600 text-sm">Kullanıcılar</a>
                    </div>
                </div>
            </header>
